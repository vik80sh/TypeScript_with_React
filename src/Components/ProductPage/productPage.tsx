                        ...
                        return <div className="product-list" key={i}>
                                ...
                                <div className="text-capitalize product-details">
                                    ...
                                    <div className="products-price">
                                        ...
                                        <div className="price-discount"><span className="prev-price">RS {data.price}</span> <span className="price-off">{offerPercentage}% off</span></div>
                                    </div>
                                    <div className="add-to-cart-btn"><button className="btn btn-primary" onClick={(data: any) => this.context.addProductToCart(data)}>Add to cart</button></div>
                                </div>
                            </div>
                            })}
                </div>
