...
export default class Home extends React.Component {
    state = {
        products: [
            ...
            },
            {
                ...
                price: '340',
                image: "https://assets.vogue.com/photos/5dc19e855e692b0008bed215/master/w_1600%2Cc_limit/End%252520of%252520Lonliness.jpg",
                rating: 3.5,
                reviewers: 976
            }
        ],
    ...
    addProductToCart = (product: any) => {
        // console.log("------cart---",this.state.cart.find((data:any)=>data.id===product.id))
        // if(this.state.cart.find((data:any)=>data.id===product.id)===undefined)
